  ...
  return (
    <div className="min-h-screen w-full bg-black text-white p-4 md:p-6">
        ...
        <div className="flex justify-between items-center gap-4">
          ...
          <div className=" ">
            <div className="flex gap-2 ">
              <button className="bg-gray-900 text-sm border-[1px] border-slate-500 py-2 px-6 rounded-md text-white hover:bg-gray-700 transition-all duration-300 ease-in-out">
                Popular
              </button>

              <div className="flex gap-1 ">
                <button className="bg-transparent border-[1px] border-slate-500 text-xl p-2 rounded-md text-white hover:bg-gray-950 transition-all duration-300 ease-in-out">
                  <MdOutlineKeyboardArrowLeft />
                </button>
                <button className="bg-gray-900 p-2 rounded-md border-[1px] border-slate-500 text-xl text-white hover:bg-gray-950 transition-all duration-300 ease-in-out">
                  <MdOutlineKeyboardArrowRight />
                </button>
              </div>
              <button className=" ml-56 text-white text-xl">
                My Wallet
              </button>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-zinc-900 rounded-xl overflow-hidden">
              ...
              <div className="p-4 cursor-pointer">
                ...
                <button className="w-full flex justify-center items-center py-2 mb-2 text-sm bg-white text-black cursor-pointer rounded-lg transition">
                  <img
                ...
                <button className="w-full flex justify-center items-center py-2 bg-black rounded-lg text-sm text-white cursor-pointer transition">
                  <img
                    src={MagicKey || "/placeholder.svg"}
                    alt="Details"
        ...
        {/* table  */}
        <div className=" bg-zinc-900 rounded-xl p-4 col-span-full overflow-x-auto">
